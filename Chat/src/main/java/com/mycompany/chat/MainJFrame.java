        ...
        jPanel3Layout.setHorizontalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(chatScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 480, Short.MAX_VALUE)
                    .addContainerGap())
        );
...
private javax.swing.JScrollPane chatScroll;
    ...
    private Consumer<String> serverSender;
    public void setServerSender(Consumer<String> sender) {
        this.serverSender = sender;
    }

    public MainJFrame(Socket incoming) {
        this();
        System.out.println("Nowe połączenie od: " + incoming.getInetAddress());
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("eva.rena@praca.gmail.com");
        ...
        jButton3.setText("tomasz.kier@praca.gmail.com");
        ...
        jButton4.setText("filip.krol@praca.gmail.com");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!text.isEmpty()) {
            if (serverSender != null) {
                serverSender.accept(text); // wyślij do wszystkich
            }
